...
//product (1 * product(nums, idx + 1);)
//product (2 * product(nums, idx + 1);)
//product (3 * product(nums, idx + 1);)
//product (4 * product(nums, idx + 1);)
//1
...
function revString(str, idx = 0, newStr = "") {
  if (idx === str.length)
    return newStr
  let leftindex = str.length - idx - 1
  newStr += str[leftindex]
  return revString(str, idx + 1, newStr)
}
